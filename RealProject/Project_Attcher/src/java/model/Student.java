...
public class Student extends User{
    ...
    public Student(String th_prename, String th_name, String en_prename, String en_name, String email, String username, String password, String type) {
    ...
    public Student(String th_prename, String th_name, String en_prename, String en_name, String email) {
        this.th_prename = th_prename;
        this.th_name = th_name;
        this.en_prename = en_prename;
        this.en_name = en_name;
